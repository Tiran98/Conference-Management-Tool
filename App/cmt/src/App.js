...
function App() {
    ...
    return ( <
        ...
        style = {
            { marginLeft: drawerWidth * drawerState }
        } >
        <
        Toolbar / >
        <
        ...
        <
        Registration setDrawerState = { setDrawerState }
        /> < /
        Route > <
        Route exact path = "/login" >
        <
        Login setDrawerState = { setDrawerState }
        /> < /
        Route > <
        Route path = '/admin'
        exact component = { admin }
        /> <
        Route path = '/adminTotReg'
        exact component = { totalRegistrations }
        /> <
        Route path = '/adminTotRev'
        exact component = { TotalRevenue }
        /> <
        Route path = '/research'
        exact component = { ResearchPage }
        /> <
        Route path = '/workshop'
        exact component = { WorkShopPage }
        /> < /
        div > <
        /Elements> < /
        Switch > <
